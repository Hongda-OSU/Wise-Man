...
- **Data** — expo-sqlite with Drizzle, migrations generated by drizzle-kit
- **State** — Zustand, one store per table
- **Interface** — StyleSheet, lucide-react-native, DM Sans and Manrope
